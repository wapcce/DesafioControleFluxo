...
no console (System.out.print) dos números incrementados, exemplo:
...
Se o primeiro parâmetro for MAIOR que o segundo parâmetro, você deverá lançar a exceção 
customizada chamada de ParametrosInvalidosException com a segunda mensagem: "O segundo parâmetro deve ser maior que o primeiro"
...
public class Contador {
	...
	static void contar(int parametroUm, int parametroDois ) throws ParametrosInvalidosException {
		...
		for (int x=1;contagem>0;contagem--) {
			System.out.print("Imprimindo o número "+ x );
			x++;
			if(contagem-1 > 0)
			System.out.print(", ");
